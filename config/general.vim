...
" Set tsx file to typescript type
autocmd BufEnter *.tsx set filetype=typescript

autocmd FileType markdown setlocal textwidth=80
autocmd FileType html,css,less,haml,sass,scss,ruby,javascript,javascript.jsx,jade,jsx,coffee,bzl,scala setlocal tabstop=2 shiftwidth=2 softtabstop=2 linespace=2
autocmd FileType python setlocal tabstop=4 shiftwidth=4 softtabstop=4 linespace=2
